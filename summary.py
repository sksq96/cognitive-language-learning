...
def run_generate():
    ...
    parser.add_argument(
        ...
        default="data/input.txt", required=False,
    )
    parser.add_argument(
        "--output_path", type=str, help="where to save summaries",
        default="data/output.txt", required=False,
    )
    ...
    # )
    parser.add_argument(
        "--batch_size", type=int, default=2, required=False, help="batch size: how many to summarize at a time",
    )
    parser.add_argument(
